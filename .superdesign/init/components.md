...
Framework: Next.js 16.2.9 with React 19.2.4. The shared primitive layer is shadcn Base Nova built on Base UI, Tailwind CSS v4, CVA, Lucide icons, and the `cn` utility.

## button

- Source: `src/components/ui/button.tsx`
- Shared primitive; key props follow the exported React/Base UI component signatures.
